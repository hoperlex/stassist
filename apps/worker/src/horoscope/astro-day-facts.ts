 ...
 * doc-комментарий packages/astro-core/src/lunar-calendar/compute-day.ts про снимок вместо
 * честного посуточного сканирования — тот же принцип): берём аспекты снимком на референсный час
 * опорной локации, а НЕ момент точного схождения (root-finding по всем планетам был бы избыточен
 * для ежедневной генерации текста; сам факт «аспект в допуске сегодня» достаточен для гороскопа).
 */
import {
