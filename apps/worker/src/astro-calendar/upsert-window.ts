 ...
 * I/O-часть предрасчёта лунного календаря; сама арифметика — в build-window.ts/compute-day.ts
 * (чистые функции). Integration-уровень (требует Postgres) — не покрывается unit-тестами
...
import type { AstroCalendarWindowDay } from './build-window.js';
