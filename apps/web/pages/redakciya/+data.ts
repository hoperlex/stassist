...
export async function data(): Promise<RedakciyaData> {
  ...
  return {
    seo: {
      title: 'Редакция Stassist — кто и как готовит материалы портала',
      description:
        'Как устроена редакция Stassist: кто отвечает за астрологические и нумерологические материалы, как проходит проверка текстов и что означают статусы «черновик» и «проверено».',
