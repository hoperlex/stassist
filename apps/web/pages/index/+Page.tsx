...
/** `/` — публичный лендинг услуг (владелец Ф8, промт req. «маркетинговые страницы», находка
 *  [страницы-без-владельца] f8.md). Реальный русский текст (не заглушка) — правило непустоты §6
