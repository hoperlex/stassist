...
export async function data(): Promise<TarifyData> {
  ...
  return {
    seo: {
      title: 'Тарифы Stassist — бесплатный доступ и Премиум-подписка',
      description:
        'Сравнение тарифов Stassist: бесплатный доступ к расчётам и первому ИИ-разбору, Премиум-подписка с полной лентой прогнозов, безлимитным чатом и скидкой на PDF. Пробный период 7 дней.',
