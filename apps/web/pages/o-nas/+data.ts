...
export async function data(): Promise<ONasData> {
  ...
  return {
    seo: {
      title: 'О проекте Stassist — как мы считаем и почему нам можно доверять',
      description:
        'Stassist — астрологический и нумерологический портал с открытым расчётным ядром: реальная астрономия вместо готовых шаблонов, честные допущения, редакционная проверка контента.',
      canonicalPath: '/o-nas',
